pipeline {
    ...
    post {
        always {
            ...
            step([$class: 'XrayImportFeatureBuilder', credentialId: '', folderPath: 'SpecflowReportIntegrationPOC/Features/', lastModified: '', preconditions: '', projectKey: 'XRAYD', serverInstance: 'SERVER-b3beffcf-1712-4a87-99f7-b7f9d4a0c25c', testInfo: ''])
